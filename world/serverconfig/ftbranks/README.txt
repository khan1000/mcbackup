...
Last README file update: Wed Nov 17 22:17:14 UTC 2021
...
command.ftbteamislands
command.ftbteamislands.change_spawn
command.ftbteamislands.create
command.ftbteamislands.delete
command.ftbteamislands.home
command.ftbteamislands.islands
command.ftbteamislands.islands.team
command.ftbteamislands.list
command.ftbteamislands.lobby
command.ftbteamislands.reload-islands-json
command.ftbteams
...
command.locate.ftbstructures:end
command.locate.ftbstructures:nether
command.locate.ftbstructures:ocean
