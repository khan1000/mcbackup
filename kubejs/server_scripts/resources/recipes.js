...
onEvent("recipes", (event) => {
    global.types
        .map((t) => t.toLowerCase())
        .forEach((t) => {
            event.shaped("rid:" + t + "_cluster", ["CC", "CC"], {
                C: "rid:" + t + "_chunk",
            });
        });
    ...
    multiSmelt("better_diving:titanium_ingot", "#forge:dusts/titanium");
    multiSmelt("tconstruct:cobalt_ingot", "rid:cobalt_dust");

    multiSmelt("projectred-core:ruby", "#forge:dusts/ruby");
    multiSmelt("projectred-core:sapphire", "#forge:dusts/sapphire");
});
